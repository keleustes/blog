...
```bash
git clone ssh://GITHUBID@review.gerrithub.io:29418/keleustes/blog && scp -p -P 29418 GITHUBID@review.gerrithub.io:hooks/commit-msg blog/.git/hooks/
...
git clone ssh://GITHUBID@review.gerrithub.io:29418/keleustes/blog && scp -p -P 29418 GITHUBID@review.gerrithub.io:hooks/commit-msg blog/.git/hooks/
cd blog
git push -f https://GITHUBID@github.com/keleustes/blog
```
